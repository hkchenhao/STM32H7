...
#define OS_CFG_DYN_TICK_EN              DEF_DISABLED            /* DisEnable (DEF_DISABLED) the Dynamic Tick                                 */
...
#define OS_CFG_TRACE_API_ENTER_EN       DEF_ENABLED             /* Enable (DEF_ENABLED) uC/OS-III Trace API enter instrumentation        */
#define OS_CFG_TRACE_API_EXIT_EN        DEF_ENABLED             /* Enable (DEF_ENABLED) uC/OS-III Trace API exit  instrumentation        */
